...
class OAI2XMLResponse {
    ...
    function __construct($uri, $verb, $request_args) {
        ...
        //$oai_node->setAttribute("xsi:schemaLocation","http://ltsc.ieee.org/xsd/LOM http://ltsc.ieee.org/xsd/lomv1.0/lom.xsd");
    ...
    // zl_temp
    function removeChild($mom_node, $node) {
 
        $mom_node->removeChild($node);
